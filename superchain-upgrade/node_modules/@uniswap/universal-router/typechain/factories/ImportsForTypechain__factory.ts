...
import type { ImportsForTypechain } from "../ImportsForTypechain";

export class ImportsForTypechain__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ImportsForTypechain {
    return new Contract(address, _abi, signerOrProvider) as ImportsForTypechain;
  }
}
