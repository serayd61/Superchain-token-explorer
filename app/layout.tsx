...
export const metadata: Metadata = {
  ...
  description: "Discover, analyze, and track token deployments across the Optimism Superchain ecosystem with real-time insights and advanced safety analytics.",
